...
public final class CollectionUtilities {
	 ...
	 * <p>
	 * <em>Hinweis:</em> Da dies eigentlich eine Mengenoperation ist, sollten bei
	 * der Verwendung dieser Methode keine Annahmen über die Reihenfolgen der
	 * Elemente im Ergebnis getroffen werden.
	 * 
	 * @param <T>   der Typ der Listen.
	 ...
	 * 
	 * @param <T>   der Typ der Listen.
	 * @param list1 die Liste von der abgezogen wird.
	 * @param list2 die Elemente dieser Liste werden abgezogen.
	...
	/**
	 * Bestimmt die Vereinigung zweier Listen. Im Ergebnis sind die Elemente doppelt
	 * vorhanden, die in beiden Listen vorhanden sind.
	 * <p>
	 * <em>Hinweis:</em> Da dies eigentlich eine Mengenoperation ist, sollten bei
	 * der Verwendung dieser Methode keine Annahmen über die Reihenfolgen der
	 * Elemente im Ergebnis getroffen werden.
	 ...
	 */
	public static <T> List<T> complement(final List<T> list1, final List<T> list2) {
	 ...
	 * 
	 * @param <T>  der Typ der Mengen.
	 * @param set1 die Menge von der abgezogen wird.
	 * @param set2 die Elemente dieser Liste werden abgezogen.
